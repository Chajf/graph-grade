...
def build_code_judge_prompt() -> ChatPromptTemplate:
...
def serialize_code_judge_context(context: CodeJudgeContext) -> str:
    return json.dumps(
        {
            ...
            "marker_findings": [
                finding.model_dump(mode="json") for finding in context.marker_findings
            ],
